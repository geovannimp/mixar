...
**Date:** 2026-07-31  
**Status:** Shipped (MessagePack omnibus + FRB `LibraryTransport`)  
**Parent patterns:** [engine event bus](./engine-event-bus-design.md), [engine session bus](./engine-session-bus-design.md)
