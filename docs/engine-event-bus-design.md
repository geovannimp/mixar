...
**Spec refs:** `docs/deck-spec.md` §7–§9; `docs/tech-spec.md`  
**Date:** 2026-07-26  
**Status:** Shipped (MessagePack omnibus + FRB `EngineTransport`)
...
| Wire codec | MessagePack (named maps) end-to-end — see `docs/engine-msgpack-wire-design.md` |
