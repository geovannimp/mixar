...
/// [MaterialApp.builder] with Forui + Shad themes + [LegacyMaterialScope].
TransitionBuilder foruiMaterialAppBuilder(
  ...
  return (context, child) {
    ...
    final data = mixarThemeData(theme, touch: false);
    return LegacyMaterialScope(
      child: FTheme(
        data: data,
        child: ShadTheme(data: shadThemeFromForui(data), child: content),
      ),
    );
  };
}
