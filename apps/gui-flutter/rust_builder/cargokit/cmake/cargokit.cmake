...
function(apply_cargokit target manifest_dir lib_name any_symbol_name)
    ...
    if (NOT EXISTS "${_cargokit_manifest_dir}/Cargo.toml")
        ...
        foreach(_cargokit_i RANGE 0 16)
            set(_cargokit_candidate "${_cargokit_walk}/crates/${lib_name}")
        ...
        if (_cargokit_manifest_dir STREQUAL "")
            message(FATAL_ERROR "cargokit: could not find crates/${lib_name}/Cargo.toml walking up from ${CMAKE_CURRENT_SOURCE_DIR}")
        endif()
    endif()
