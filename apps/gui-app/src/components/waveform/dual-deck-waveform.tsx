...
import { useWaveformDragScrub } from "@/hooks/use-waveform-drag-scrub";
import { useSmoothPlayhead } from "@/hooks/use-smooth-playhead";
import { useDeckHasTrack } from "@/hooks/engine/use-deck-has-track";
import { useDeckPosition } from "@/hooks/engine/use-deck-position";
import { useDeckWaveform } from "@/hooks/engine/use-deck-waveform";
...
import { useRenderWaveformLane } from "@/hooks/use-render-waveform-lane";
import { RustRenderedLane } from "./rust-rendered-lane";
import { useLaneDimensions } from "./use-lane-dimensions";
import { WaveformWindowMarkersMotion } from "./waveform-window-markers-motion";
