...
export function DialogPanel({
  ...
  const defaultProps = {
    className: cn(
      "min-h-0 flex-1 overflow-y-auto p-6 in-[[data-slot=dialog-popup]:has([data-slot=dialog-header])]:pt-1 in-[[data-slot=dialog-popup]:has([data-slot=dialog-footer]:not(.border-t))]:pb-1",
      className,
    ),
