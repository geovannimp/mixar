...
import { LOOP_ROLL_BEATS, formatBeatLength } from "@/lib/pad-modes";
  ...
  return (
    <PadGridContainer>
      {Array.from({ length: 8 }, (_, slot) => {
        ...
        const label = formatBeatLength(beats);
        return (
          <DeckButton
            key={slot}
            type="button"
          ...
          >
            <span className="text-sm font-bold leading-none sm:text-base">{label}</span>
