...
pub fn builtin_manifest(model_name: &str) -> Result<ModelManifest> {
    match model_name {
        "htdemucs_mixxx_v1" => Ok(ModelManifest {
            name: "htdemucs_mixxx_v1".into(),
            sample_rate: 44_100,
            artifacts: vec![Artifact {
                file: "htdemucs.onnx".into(),
                // mixxxdj/demucs release v4.0.1-19-gd182d42-onnxmodel
...
mod tests {
    ...
    #[test]
    fn builtin_manifest_htdemucs_mixxx_v1() {
        ...
        assert_eq!(art.file, "htdemucs.onnx");
        assert_eq!(art.format, "onnx");
        assert_eq!(art.size_bytes, 304_413_278);
        assert_eq!(
            art.sha256,
            "db37d1314ac1e1051e7978d25ef45b3f1d3f43c837678752f592c0f2deca752d"
        );
        assert!(art.url.contains("mixxxdj/demucs"));
    }
